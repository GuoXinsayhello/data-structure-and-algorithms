...
####为什么接口中的变量必须是public static final的？
下面的解释来自http://blog.csdn.net/ameyume/article/details/6189749<br>
...
##第56条：遵守普遍接受的命名惯例
类型参数名称通常由单个字母组成，T表示任意类型，E表示集合的元素类型，K和V表示映射的键和值类型，X表示异常。接口的命名一般以“-able”或者“-ible”结尾
第9章：异常
--
2016/7/11看到217页
第10章：并发
